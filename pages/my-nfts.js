...
export default function MyAssets() {
  ...
  async function LoadNFTs() {
    ...
    const marketContract = new ethers.Contract(nftMarketaddress, KryptoAmir.abi, signer);
  ...
  if (loadingState==="Loaded" && !nfts.length){
    return <div style={{width:100,height:200,marginLeft:150,marginTop:150}}><h1 style={{color:'white',marginTop:100,marginLeft:100,fontSize:50}} >you dont have any NFTs in Market yet</h1></div> 
  } 
